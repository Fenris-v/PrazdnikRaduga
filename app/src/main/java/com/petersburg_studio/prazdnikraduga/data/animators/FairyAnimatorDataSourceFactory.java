...
public class FairyAnimatorDataSourceFactory extends DataSource.Factory {
    ...
    public DataSource<Integer, Items> create() {
        FairyAnimatorDataSource fairyAnimatorDataSource = new FairyAnimatorDataSource();
        itemLiveDataSource.postValue(fairyAnimatorDataSource);
        return fairyAnimatorDataSource;
    }
