...
import com.petersburg_studio.prazdnikraduga.data.others.SeasonsDataSourceFactory;
...
public class SeasonsViewModel extends ViewModel {
    ...
    public SeasonsViewModel() {
        SeasonsDataSourceFactory additionalDataSourceFactory = new SeasonsDataSourceFactory();
