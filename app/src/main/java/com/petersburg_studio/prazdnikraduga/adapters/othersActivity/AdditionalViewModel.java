...
import com.petersburg_studio.prazdnikraduga.data.others.AdditionalDataSourceFactory;
...
public class AdditionalViewModel extends ViewModel {
    ...
    public AdditionalViewModel() {
        AdditionalDataSourceFactory additionalDataSourceFactory = new AdditionalDataSourceFactory();
