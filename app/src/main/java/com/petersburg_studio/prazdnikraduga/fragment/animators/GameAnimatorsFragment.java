...
import com.petersburg_studio.prazdnikraduga.adapters.animators.types.GameAnimatorViewModel;
...
public class GameAnimatorsFragment extends Fragment implements WaveSwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadItems() {
        ...
        GameAnimatorViewModel productViewModel =
                ViewModelProviders.of(this).get(GameAnimatorViewModel.class);
