...
import com.petersburg_studio.prazdnikraduga.adapters.animators.types.SuperheroAnimatorViewModel;
...
public class SuperheroAnimatorsFragment extends Fragment implements WaveSwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadItems() {
        ...
        SuperheroAnimatorViewModel productViewModel =
                ViewModelProviders.of(this).get(SuperheroAnimatorViewModel.class);
