...
import com.petersburg_studio.prazdnikraduga.adapters.animators.types.CartoonAnimatorViewModel;
...
public class CartoonAnimatorsFragment extends Fragment implements WaveSwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadItems() {
        ...
        CartoonAnimatorViewModel productViewModel =
                ViewModelProviders.of(this).get(CartoonAnimatorViewModel.class);
