...
import com.petersburg_studio.prazdnikraduga.adapters.othersActivity.AdditionalViewModel;
...
public class AdditionalServicesFragment extends Fragment implements WaveSwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadItems() {
        if (CheckInternetConnection.checkConnection((Objects.requireNonNull(getActivity())).getApplicationContext())) {
            ...
            AdditionalViewModel productViewModel =
