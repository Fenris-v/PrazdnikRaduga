...
import com.petersburg_studio.prazdnikraduga.adapters.othersActivity.MastersViewModel;
...
public class MastersFragment extends Fragment implements WaveSwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadItems() {
        if (CheckInternetConnection.checkConnection((Objects.requireNonNull(getActivity())).getApplicationContext())) {
            ...
            MastersViewModel productViewModel =
                    ViewModelProviders.of(this).get(MastersViewModel.class);
