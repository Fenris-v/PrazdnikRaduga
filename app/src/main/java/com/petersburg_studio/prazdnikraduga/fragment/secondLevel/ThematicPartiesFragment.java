...
import com.petersburg_studio.prazdnikraduga.adapters.othersActivity.ThematicViewModel;
...
public class ThematicPartiesFragment extends Fragment implements WaveSwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadItems() {
        if (CheckInternetConnection.checkConnection((Objects.requireNonNull(getActivity())).getApplicationContext())) {
            ...
            ThematicViewModel productViewModel =
