...
import com.petersburg_studio.prazdnikraduga.adapters.animators.types.RealisticAnimatorViewModel;
...
public class RealisticAnimatorsFragment extends Fragment implements WaveSwipeRefreshLayout.OnRefreshListener {
    ...
    private void loadItems() {
        ...
        RealisticAnimatorViewModel productViewModel =
                ViewModelProviders.of(this).get(RealisticAnimatorViewModel.class);
